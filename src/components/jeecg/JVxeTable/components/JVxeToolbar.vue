<template>
  <div :class="boxClass">
    ...
    <div class="j-vxe-tool-button div" :size="btnSize">
      ...
      <a-button v-if="showAdd" icon="plus" @click="trigger('add')" :disabled="disabled" type="primary">New</a-button>
      ...
      <template v-if="selectedRowIds.length > 0">
        ...
        >
          <a-button icon="minus" :disabled="disabled"> Delete </a-button>
        </a-popconfirm>
  ...
  export default {
    ...
    computed: {
      ...
      btns() {
        ...
        // 系统默认的Batch Delete 编码配置为 batch_delete 此处需要转化一下
