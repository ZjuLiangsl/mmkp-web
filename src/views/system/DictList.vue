  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      ...
      <div class="table-operator" style="border-top: 5px">
        ...
        <a-button type="primary" icon="sync" @click="refleshCache()">Refresh</a-button>

        <a-button type="primary" icon="hdd" @click="openDeleteList">Delete</a-button>
      </div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a @click="editDictItem(record)"><a-icon type="setting"/> Configure</a>
          <a-divider type="vertical"/>
