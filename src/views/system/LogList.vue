        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="Search">
              <a-input placeholder="Holder—Search" v-model="queryParam.keyWord"></a-input>
            </a-form-item>
          </a-col>

          <a-col :md="6" :sm="10">
            <a-form-item label="Creation Time" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-range-picker
                style="width: 210px"
          ...
          <a-col :md="5" :sm="8" v-if="tabKey === '2'">
            <a-form-item label="Operator Type" style="left: 10px">
              <j-dict-select-tag v-model="queryParam.operateType" placeholder="Operator Type" dictCode="operate_type"/>
            </a-form-item>
          </a-col>

          <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
            <a-col :md="6" :sm="24">
                <a-button type="primary" style="left: 10px" @click="searchQuery" icon="search">Query</a-button>
                <a-button type="primary" @click="searchReset" icon="reload"
                          style="margin-left: 8px;left: 10px">Reset</a-button>
            </a-col>
          </span>
