      ...
      <a-card :bordered="false">
        ...
        <div class="table-page-search-wrapper">
          ...
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            <a-row :gutter="24">
              <a-col :md="12" :sm="8">
                <a-form-item label="Role Name" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
            ...
            <a-col :md="12" :sm="24">
               <a-button type="primary" @click="searchQuery" icon="search" style="margin-left: 21px">Query</a-button>
        ...
        <div class="ant-alert ant-alert-info" style="margin-bottom: 16px;">
          ...
          </i><a><b>{{ selectedRowKeys1.length }}</b> Selected</a>
          <a style="margin-left: 24px" @click="onClearSelected1">Empty</a>
        </div>
        ...
        <div style="margin-top: 15px">
          ...
          <span slot="action" slot-scope="text, record">
            ...
            <a-dropdown>
              ...
              <a-menu slot="overlay">
                <a-menu-item>
                  <a @click="handlePerssion(record.id)">Authorization</a>
                </a-menu-item>
                <a-menu-item>
                  <a @click="handleEdit(record)">Edit</a>
                </a-menu-item>
                <a-menu-item>
                  <a-popconfirm title="Are you sure?" @confirm="() => handleDelete1(record.id)">
                    <a>Delete</a>
                  </a-popconfirm>
                </a-menu-item>
              </a-menu>
    ...
    <a-col :md="rightColMd" :sm="24" v-if="this.rightcolval == 1">
      <a-card :bordered="false">
        ...
        <div class="table-page-search-wrapper">
          <a-form layout="inline">
            <a-row :gutter="24">
              ...
              <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
            <a-col :md="9" :sm="24">
             <a-button type="primary" @click="searchQuery2" icon="search" style="margin-left: 21px">Query</a-button>
              <a-button type="primary" @click="searchReset2" icon="reload" style="margin-left: 8px">Reset</a-button>
        ...
        <div class="table-operator" :md="24" :sm="24">
          <a-button @click="handleAdd2" type="primary" icon="plus" style="margin-top: 16px">New User</a-button>
        ...
        <div>
          <div class="ant-alert ant-alert-info" style="margin-bottom: 16px;">
            ...
            <a style="margin-left: 24px" @click="onClearSelected2">Empty</a>
          </div>
          <a-table
            style="height:500px"
            ref="table2"
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              <a-menu-item>
                <a-popconfirm title="Are you sure?" @confirm="() => handleDelete2(record.id)">
                  <a>Delete</a>
                </a-popconfirm>
              </a-menu-item>
            </a-menu>
  ...
  methods: {
    ...
    loadData2(arg) {
      ...
      getAction(this.url.list2, params).then((res) => {
        if (res.success) {
          ...
          this.ipagination2.total = parseInt(res.result.total)
    ...
    batchDel2: function() {
      ...
      if (this.selectedRowKeys2.length <= 0) {
        ...
        this.$confirm({
          title: 'Delete ',
          content: 'Yes No Delete Selected data??',
          onOk: function() {
