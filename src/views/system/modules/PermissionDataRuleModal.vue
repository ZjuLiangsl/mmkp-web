    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item
          ...
          prop="ruleConditions"
          label="条件规则">
          <j-dict-select-tag @input="handleChangeRuleCondition" v-model="model.ruleConditions" placeholder="请输入条件规则"
        ...
        <a-form-model-item
          ...
          <a-input placeholder="Plases Input Strategy Value" v-model.trim="model.ruleValue"/>
        </a-form-model-item>
  ...
  data() {
    return {
      ...
      validatorRules: {
        ...
        ruleValue: [{ required: true, message: 'Plases Input Strategy Value!' }],
        ruleColumn: []
      },
      url: {
