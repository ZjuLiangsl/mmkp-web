    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item
          ...
          prop="itemText"
          label="Name">
          <a-input placeholder="Please Input  Name" v-model="model.itemText"/>
        </a-form-model-item>
        ...
        <a-form-model-item
          ...
          prop="itemValue"
          label="Value">
          <a-input placeholder="Please Input Value" v-model="model.itemValue"/>
        </a-form-model-item>
...
export default {
  ...
  data() {
    return {
      ...
      validatorRules: {
        itemText: [{ required: true, message: 'Please Input  Name!' }],
        itemValue: [{ required: true, message: 'Please Input  Value!' }, { validator: this.validateItemValue }]
      }
    }
  },
  created() {
