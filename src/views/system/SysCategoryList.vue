<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('分类字典')">Export</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-popconfirm title="Are you sure?" @confirm="() => handleDelete(record)">
            <a>Delete</a>
          </a-popconfirm>
          <a-divider type="vertical"/>
        ...
        getAction(this.url.list, params).then(res => {
          if (res.success) {
            ...
            if (Number(result.total) > 0) {
              ...
              //update--begin--autor:lvdandan-----date:20201204------for：JT-31  Delete the success后默认展开已展开信息
              return this.loadDataByExpandedRows(this.dataSource)
              //update--end--autor:lvdandan-----date:20201204------for：JT-31  Delete the success后默认展开已展开信息
            } else {
